...
// Get your shorts on - this is an array workout!
    ...
    const inventors = [
      ...
      const namesAndSernames = inventors.map( inventor =>  {
            let inventorFull = {}
            inventorFull.first = inventor.first;
            inventorFull.last  = inventor.last;
            return inventorFull;
      } );
      console.log(firstAndLast);
      console.log(namesAndSernames);
      ...
      const livedSum =  inventors.map((inventor) => (inventor.passed - inventor.year)).reduce((acc, curr)=> acc + curr);
      console.log(livedSum);
